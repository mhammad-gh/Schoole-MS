...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    for ($i = 0; $i < $files_count; $i++) {
        move_uploaded_file(
            $image_temp[$i],
            'C:\xampp1\htdocs\project\project1\admin1\pdf_10\\' .
                $image_name[$i]
        );
    }
}
...
<html lang="en">
  ...
  <section id="calendar">
    <h1 class="heading">
      <span>upload coursses the ten class</span>
    ...
    <div>
    <input type="submit" name='operator' value="Uplode" class="btn btn-primary mb-2" id="upload"  /><br></br>
